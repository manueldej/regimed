	...
	<table width="90%" border="0" align="center">
				...
				<form name="frm1" method="post" action="">        
					<table width="90%" height="71" border="0" cellpadding="0" cellspacing="0" class="table" align="center">
						...
						while($row=mysqli_fetch_array($result)) { $i++;  ?>
							<tr id="cur_tr_<?php echo $p;?>" bgcolor="<?php  echo $uCPanel->ColorFila($p,$color1,$color2);?>" onMouseOver="this.style.background='#CCFFCC'; colorear('<?php echo $p;?>','#CCFFCC'); this.style.cursor='pointer';" onMouseOut="this.style.background='<?php  echo $uCPanel->ColorFila($p,$color1,$color2);?>'; colorear('<?php echo $p;?>','#FCF8E2');" onclick="exped('<?php echo $row['id'];?>'); marca1(<?php echo $p;?>,'#ffffff')" onContextMenu="<?php if ($rus['tipo']=="root") {?>contextual(event,'<?php echo $row["id"]?>'); <?php } ?>"> 
						...
						} if(($rus['tipo'] =="root") and ($rowsella!=0)){	?>
							<tr align="center">
		...
		<tr>
			<td><?php include('navegador.php');?></td>
	                    ...
	                    <div align="center"><div class="message"><?php echo $espreciso; ?></div></div> 
						<form name="frm1" method="post" action="">        
