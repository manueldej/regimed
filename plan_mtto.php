...
<fieldset class="fieldset"><legend class="vistauserx"><?php echo $btpmtto1;?><?php if(($unidadactiva) !=""){ echo "&nbsp;&nbsp;&nbsp;".$btdatosentidad3.": <font color='red'>".$unidadactiva."</font>"; }?></legend>
	...
	if(isset($_REQUEST['edit']) OR isset($_REQUEST['edit'])){
		...
		<br></fieldset>
		 <?php include ("version.php");?>
		<iframe width="174" height="189" name="gToday:normal:agenda.js" id="gToday:normal:agenda.js" src="js/ipopeng.htm" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; left:-501px; top:0px;"></iframe>
...
<?php 
    if (isset($_SESSION["valid_user"]))  {
		...
		<script type="text/javascript">
			...
			<?php if(($con) =="m"){ ?><div align="right"></div><?php }  ?>			
				...
				<iframe width=174 height=189 name="gToday:normal:agenda.js" id="gToday:normal:agenda.js" src="js/ipopeng.htm" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; left:-501px; top:0px;"></iframe><?php 
		}
	} 
	...
	if((@$rsel['visitas']) !=""){
		...
		if(isset($_REQUEST['bus_fecha'])){
			...
			$fe_bu = " WHERE mtto.estado='Pendiente'";
		}

		$sql="SELECT aft.inv, aft.categ, aft.idarea, aft.idunidades, mtto.id, mtto.inv,mtto.fecha, mtto.estado, mtto.idunidades FROM mtto INNER JOIN (aft) ON (mtto.inv = aft.inv) ".$fe_bu." order by mtto.fecha ASC"; 
    	...
    	$sqlzb="SELECT * FROM mtto ".$fe_bu." order by fecha ASC"; 
