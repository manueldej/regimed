...
<script language="javascript">
	...
	function creasalva($tabla1,$i){
				...
				$ruta = substr($roo, 0, $posicion)."/tmp/"; 
							...
							if (($export==1)){
								...
								foreach($tbl AS $key=>$tabla)	{
									...
									$fiq = mysqli_query($miConex, $fi) or die(mysql_error($miConex)); 												
		...
		$gh=0;
		$seldgx = mysqli_query($miConex, "select * from datos_generales where id_datos !='1'") or die(mysql_error());
		while($Key = mysqli_fetch_array($seldgx)){

		$seldg = mysqli_query($miConex, "select * from datos_generales where id_datos='".$Key['id_datos']."'") or die(mysql_error());
		$rseldg = mysqli_fetch_array($seldg);
		...
		$seldselreg_claves = mysqli_query($miConex, "select * from usuarios where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
			while($rselreg_claves = mysqli_fetch_array($seldselreg_claves)){
				if(($rselreg_claves['idarea']) =="Inform&aacute;tica"){
					$selreg_claves = mysqli_query($miConex, "update reg_claves set idunidades='1', idarea='Inform&aacute;tica(F_".$rseldg['codigo'].")' where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());			
				}else{
					$selreg_claves = mysqli_query($miConex, "update reg_claves set idunidades='1' where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());					
				}
			}

			$selaftareas = mysqli_query($miConex, "update areas set idunidades='1', nombre='Inform&aacute;tica(F_".$rseldg['codigo'].")' where nombre='Inform&aacute;tica'  AND idunidades='".$rseldg['id_datos']."'") or die(mysql_error());			
			$selaftareas1 = mysqli_query($miConex, "update areas set idunidades='1' where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());					
			...
			while($rselreg_aft = mysqli_fetch_array($seldselreg_aft)){
				if(($rselreg_aft['idarea']) =="Inform&aacute;tica"){
					$selaft1 = mysqli_query($miConex, "update aft set idunidades='1' , idarea='Inform&aacute;tica(F_".$rseldg['codigo'].")'  where  idarea='Inform&aacute;tica'  AND idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
				}else{
					$selaft1 = mysqli_query($miConex, "update aft set idunidades='1'  where  idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
				}
			}
			...
			while($rselreg_aft1 = mysqli_fetch_array($seldselreg_aft1)){
				if(($rselreg_aft1['idarea']) =="Inform&aacute;tica"){
					$selbajas_aft1 = mysqli_query($miConex, "update bajas_aft set idunidades='1' , idarea='Inform&aacute;tica(F_".$rseldg['codigo'].")'  where  idarea='Inform&aacute;tica'  AND idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
				}else{
					$selbajas_aft1 = mysqli_query($miConex, "update bajas_aft set idunidades='1'  where  idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
				}
			}
			...
			while($rselreg_exp = mysqli_fetch_array($seldselreg_exp)){
				if(($rselreg_exp['idarea']) =="Inform&aacute;tica"){
					$selbajas_exp = mysqli_query($miConex, "update bajas_exp set idunidades='1' , idarea='Inform&aacute;tica(F_".$rseldg['codigo'].")'  where  idarea='Inform&aacute;tica'  AND idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
				}else{
					$selbajas_exp = mysqli_query($miConex, "update bajas_exp set idunidades='1'  where  idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
				}
			}
			...
			while($rselreg_expd = mysqli_fetch_array($seldselreg_expd)){
				if(($rselreg_expd['idarea']) =="Inform&aacute;tica"){
					$selbajas_expd = mysqli_query($miConex, "update exp set idunidades='1' , idarea='Inform&aacute;tica(F_".$rseldg['codigo'].")'  where  idarea='Inform&aacute;tica'  AND idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
				}else{
					$selbajas_expd = mysqli_query($miConex, "update exp set idunidades='1'  where  idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
				}
			}

			$seltraspasos = mysqli_query($miConex, "update traspasos set idunidades='1' where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
			$seltraspasos1 = mysqli_query($miConex, "update traspasos set idunidades='1', origen='Inform&aacute;tica(F_".$rseldg['codigo'].")'  where origen='Inform&aacute;tica'  AND idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
			...
			$selinspecciones = mysqli_query($miConex, "update inspecciones set idunidades='1', area='".$cadimp."' where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());

			$selmtto = mysqli_query($miConex, "update mtto set idunidades='1' where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());

			$selplan_rep = mysqli_query($miConex, "update plan_rep set idunidades='1' where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
			$selplan_rep1 = mysqli_query($miConex, "update plan_rep set idunidades='1', idarea='Inform&aacute;tica(F_".$rseldg['codigo'].")'  where  idarea='Inform&aacute;tica'  AND idunidades='".$rseldg['id_datos']."'") or die(mysql_error());

			$selpreferencias = mysqli_query($miConex, "update preferencias set idunidades='1' where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());
			...
			while($rseldgareasselusuarios = mysqli_fetch_array($seldgareasselusuarios)){
				if(($rseldgareasselusuarios['idarea']) =="Inform&aacute;tica"){
					$selusuarios = mysqli_query($miConex, "update usuarios set idunidades='1', idarea='Inform&aacute;tica(F_".$rseldg['codigo'].")' where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());			
				}else{
					$selusuarios = mysqli_query($miConex, "update usuarios set idunidades='1' where idunidades='".$rseldg['id_datos']."'") or die(mysql_error());					
				}
			}

			$seldg = mysqli_query($miConex, "delete from datos_generales where id_datos='".$Key['id_datos']."'") or die(mysql_error());
			$gh++;
		} 		
