...
<div id="modal6" class="modalmask" style="background: rgba(63, 57, 57, 0.7);">
	...
	<form action="" method="post" name="componente">
		...
		<tr>
		  ...
		  <td width="54%" align="center"><div align="center"><input name="<?php echo $nombcampo[$a]; ?>1" id="<?php echo $nombcampo[$a]; ?>1" type="text" onkeypress="return handleEnter(this, event)" required value="<?php echo $rows1[$nombcampo[$a]]; ?>" class="form-control" onblur="componente.<?php echo $nombcampo[$a]; ?>.value=this.value; <?php if($_REQUEST['accion']=='editar') { ?>__editcompo('<?php echo $nombcampo[$a]; ?>','<?php echo $rows1['id']; ?>',this.value,'<?php echo $nombcampo[$a]; ?>'); <?php } ?>"></div></td>
		</tr><?php } ?>
		...
		<tr>
			<td colspan="2"><?php
				if(($num_resultados1) !=0){
					// Si hay resultados crea una tabla y los muestra		
						...
						while ($row=mysqli_fetch_array($result1)){ 
							...
							<tr>
								...
								<table width="30%" align="center" class="table"><?php if ($numre!=0) { 
					...
					<input name="crea" type="button" value="<?php echo $btCreate;?>" class="btn" onclick="__creaExpt('<?php echo $categ;?>','<?php echo @$marcado;?>','<?php echo $idunddes;?>');"><?php
				}
				...
				if ($num_resultados !=0){ ?>
				    <table width="100%" border='1' style="border-color: rgb(204, 221, 240); border-style: solid;" cellpadding="0" cellspacing="0" class="table" > 
						...
						while ($row = mysqli_fetch_array($result)) { 
							...
							<tr>
								...
								<span onmouseover="this.style.color='rgb(79, 105, 179)';" onmouseout="this.style.color='rgb(0, 0, 0)';"><?php echo @$memoriasf[0];?><?php if ($numre!=0) { ?><i id="editmemoria" onclick="seguro4('<?php $memoriasf[0]; ?>','<?php echo $categ;?>','<?php echo $idunidadesc;?>','<?php echo $palabra;?>','rm','Memorias','<?php echo $memoriasf[0]; ?>','editar');" manolo="Editar&nbsp;<?php echo $memoriasf[0]; ?>" style="cursor:pointer; height: 26px; width: 16px; float: left; position: absolute; cursor:pointer; margin-top: 0px; margin-left: 4px; background: transparent url(&quot;images/glyphicons-halflings.png&quot;) repeat scroll -1px -226px;"></i><i id="deleMEMORIA2" onclick="__deletecompo('<?php echo $filacomp["id"]; ?>'); __ir('<?php echo $categ;?>','<?php echo $idunidadesc;?>','<?php echo $palabra;?>','rm');" manolo="Eliminar Compontes del:&nbsp;<?php echo $memoriasf[0]; ?>" style="cursor:pointer; height: 26px; width: 16px; float: left; position: absolute; cursor:pointer; margin-top: 0px; margin-left: 21px; background: transparent url(&quot;images/glyphicons-halflings.png&quot;) repeat scroll -23px -250px;"></i></span>
								...
								<span onmouseover="this.style.color='rgb(79, 105, 179)';" onmouseout="this.style.color='rgb(0, 0, 0)';"><?php echo @$memoriasf[2]; ?><?php if ($numre!=0) { ?><i id="editmemoria" onclick="seguro4('<?php $memoriasf[2]; ?>','<?php echo $categ;?>','<?php echo $idunidadesc;?>','<?php echo $palabra;?>','rm','Memorias','<?php echo $memoriasf[2]; ?>','editar');" manolo="Editar&nbsp;<?php echo $memoriasf[2]; ?>" style="cursor:pointer; height: 26px; width: 16px; float: left; position: absolute; cursor:pointer; margin-top: 0px; margin-left: 4px; background: transparent url(&quot;images/glyphicons-halflings.png&quot;) repeat scroll -1px -226px;"></i><i id="deleMEMORIA3" onclick="__deletecompo('<?php echo $filacomp["id"]; ?>'); __ir('<?php echo $categ;?>','<?php echo $idunidadesc;?>','<?php echo $palabra;?>','rm');" manolo="Eliminar Compontes del:&nbsp;<?php echo $memoriasf[2]; ?>" style="cursor:pointer; height: 26px; width: 16px; float: left; position: absolute; cursor:pointer; margin-top: 0px; margin-left: 21px; background: transparent url(&quot;images/glyphicons-halflings.png&quot;) repeat scroll -23px -250px;"></i></span>
					...
					<table width="100%" BORDER='1' style="border-color: rgb(204, 221, 240); border-style: solid;" cellpadding="0" cellspacing="0" class="table" > 
							 <tr> 
								...
								<span onmouseover="this.style.color='rgb(79, 105, 179)';" onmouseout="this.style.color='rgb(0, 0, 0)';"><?php echo $row["GRAFICS"];?><?php if ($numre!=0) { ?><i id="editmemoria" onclick="seguro4('<?php $row["GRAFICS"]; ?>','<?php echo $categ;?>','<?php echo $idunidadesc;?>','<?php echo $palabra;?>','rm','Tarjeta Grafica','<?php echo $row["GRAFICS"]; ?>','editar');" manolo="Editar&nbsp;<?php echo $row["GRAFICS"]; ?>" style="cursor:pointer; height: 26px; width: 16px; float: left; position: absolute; cursor:pointer; margin-top: 0px; margin-left: 4px; background: transparent url(&quot;images/glyphicons-halflings.png&quot;) repeat scroll -1px -226px;"></i><i id="deleGrafics" onclick="__deletecompo('<?php echo $filacomp["id"]; ?>'); __ir('<?php echo $categ;?>','<?php echo $idunidadesc;?>','<?php echo $palabra;?>','rm');" manolo="Eliminar Compontes del:&nbsp;<?php echo $row["GRAFICS"]; ?>" style="cursor:pointer; height: 26px; width: 16px; float: left; position: absolute; cursor:pointer; margin-top: 0px; margin-left: 21px; background: transparent url(&quot;images/glyphicons-halflings.png&quot;) repeat scroll -23px -250px;"></i></span>
