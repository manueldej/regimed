...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td width="18%"><div align="center"><span><a href="#"><img onClick="javascript:document.comp.submit();" src="images/pc.png" alt="Computadoras" width="36" height="32" border="0"/><span></span></a></div></td>
	...
	<tr>
		<td valign="top">
					<form action="registromedios1.php" method="post" name="tipocompu" id="tipocompu">
					    <div align="center">
					      <select name="palabra" id="palabra" class="imputf custom-select d-block w-100" onChange="return busca_tipo(this.form);">
