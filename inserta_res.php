...
$e="";
	...
	if(isset($_POST['edit']) OR isset($_GET['editar'])){
		...
		<iframe width="174" height="189" name="gToday:normal1:js/agenda1.js" id="gToday:normal1:js/agenda1.js" src="js/ipopeng.htm" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; left:-501px; top:0px;"></iframe><?php 		
	}
	...
	if(isset($_POST['new']) OR isset($_GET['n'])){
		...
		<iframe width=174 height=189 name="gToday:normal2:js/agenda2.js" id="gToday:normal2:js/agenda2.js" src="js/ipopeng.htm" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; left:-501px; top:0px;"></iframe><?php
	} ?>
</div>
