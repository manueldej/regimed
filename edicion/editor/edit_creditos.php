...
<fieldset class='fieldset'><legend class='vistauserx'><font face='Verdana, Arial, Helvetica, sans-serif' size ='1'>MODIFICAR MANUALES</font></legend><?php
	if (isset($_POST['manuales'])) {		  
		   $SQL_Creditos ="UPDATE manuales SET manuales = '".$_POST['manuales']."'";
		   $SQL_Creditos1 = "DELETE FROM manuales WHERE manuales ='' ";
		...
		<form action="edit_creditos.php" method="post">
			<textarea class="ckeditor" cols="80" id="manuales" name="manuales" rows="10"><?php echo $ver;?></textarea>
	</form>
			<br>
	...
	if (!empty($result)) {
		...
		<script language="javascript">
			document.location = '../../manuales.php';
		</script>
	   <?php
	 }
?>
