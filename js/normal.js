...
//INICIO DE CODIGO
//ESTE TROZO DE CODIGO ESPARA SELECCIONAR LA FAECHA A PARTIR DE LA FECHA ACTUAL MSc. Carlos Pollan Estrada cpollan[at]ahmzllo.granma.inf.cu
var mydateq=new Date();
var yeara=mydateq.getYear();
if (yeara < 1000)
	yeara+=1900;
var daya=mydateq.getDay();
var montha=mydateq.getMonth();
var dayma=mydateq.getDate();
if (dayma<10)
	dayma="0"+dayma;

var gBegin=[yeara,montha+1,dayma];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
//FIN DE CODIGO
var gEnd=[2030,12,31];	// calendar date range end at [Year,Month,Date]
var gsOutOfRange="No puede ir mas alla del rango definido";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
