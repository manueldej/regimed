...
function handleEnter (field, event) { 
 ...
 function alertaradio(err,men,tipo) { 
	...
	function checke() {
        ...
        if (f.inv.value == '') {
			document.getElementById('cira').innerHTML='<div class="alert negro" style="margin-left: 156px;"><button class="closex" type="button" onclick="cierr1();">X</button><div align="center"><font color="#FFDCA8" size="3"><b><?php echo $advierte;?></b></font></div><div align="center"><b>El campo -Inv- esta en blanco.".</b></div></div>';
			f.inv.focus();
			formValid=false;
		}else if ( f.desc.value == '' ) {
			document.getElementById('cira').innerHTML='<div class="alert negro" style="margin-left: 156px;"><button class="closex" type="button" onclick="cierr1();">X</button><div align="center"><font color="#FFDCA8" size="3"><b><?php echo $advierte;?></b></font></div><div align="center"><b>Por favor seleccione la -Descripcion-.".</b></div></div>';
			f.desc.focus(); 
			formValid=false; 	
		}else if ((f.estado.value) == '' || (f.estado.value) == '') {
			document.getElementById('cira').innerHTML='<div class="alert negro" style="margin-left: 156px;"><button class="closex" type="button" onclick="cierr1();">X</button><div align="center"><font color="#FFDCA8" size="3"><b><?php echo $advierte;?></b></font></div><div align="center"><b>Por favor seleccione o escriba el -Estado-.".</b></div></div>';
			f.estado.focus(); 
			formValid=false; 	
		}else if ( f.marca.value == '' ) {
			document.getElementById('cira').innerHTML='<div class="alert negro" style="margin-left: 156px;" ><button class="closex" type="button" onclick="cierr1();">X</button><div align="center"><font color="#FFDCA8" size="3"><b><?php echo $advierte;?></b></font></div><div align="center"><b>Por favor seleccione el -Marca-.".</b></div></div>';
			f.marca.focus(); 
			formValid=false;
		}else if ( f.flash.value == '-1' ) {
			document.getElementById('cira').innerHTML='<div class="alert negro" style="margin-left: 156px;"><button class="closex" type="button" onclick="cierr1();">X</button><div align="center"><font color="#FFDCA8" size="3"><b><?php echo $advierte;?></b></font></div><div align="center"><b>Por favor seleccione el -Categoria-.".</b></div></div>';
			f.flash.focus(); 
			formValid=false;
		}else if ( (f.custo.value =='-1') || (f.custo.value =='') ) {
			document.getElementById('cira').innerHTML='<div class="alert negro" style="margin-left: 156px;"><button class="closex" type="button" onclick="cierr1();">X</button><div align="center"><font color="#FFDCA8" size="3"><b><?php echo $advierte;?></b></font></div><div align="center"><b>Por favor seleccione el -Custodio-.".</b></div></div>';
			f.custo.focus(); 
			formValid=false;
