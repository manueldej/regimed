...
<fieldset class='fieldset'><legend class="vistauserx"><?php echo $btcreditos1;?></legend>
	<table align="center" border="0" cellpadding="0" cellspacing="0" style="height:440px; width:886px">
	    <tr>
			<td align="center" valign="top">
				...
				<div align="justify"><span style="color: red"><strong>Registro de Medios&nbsp;Inform&aacute;ticos</strong></span>, idea original, dise&ntilde;o y programaci&oacute;n: <a href="?m#modal2" class="tooltip"><font color="#000000"><b>Ing. Manuel de Jes&uacute;s N&uacute;&ntilde;ez Guerra</b></font><span onmouseover="this.style.cursor='pointer';"><?php echo $click1.strtolower($sho).$bddatosper;?></span></a>, Especialista B en Ciencias Inform&aacute;ticas de la F&aacute;brica &quot;Manuel Fajardo Rivero&quot;, programaci&oacute;n: <a class="tooltip" href="?p#modal2"><font color="#000000"><b>MSc. Carlos Poll&aacute;n Estrada</b></font><span onmouseover="this.style.cursor='pointer';"><?php echo $click1.strtolower($sho).$bddatosper;?></span></a>, Especialista en Ciencias Inform&aacute;ticas del Archivo Hist&oacute;rico de Manzanillo &quot;Modesto Tirado&quot;.&nbsp;</div>
			</td>
		</tr>
	    <tr>
	...
	if(isset($_GET['m'])){
		...
		$ima='manuel.jpg';
		$textoam='Especialista B en Ciencias Inform&aacute;ticas de la Empresa de Servicios T&eacute;cnicos Industriales ZETI - UEB F&aacute;brica &quot;Manuel Fajardo Rivero.<br> email:<a href=mailto:manuel.jesus@zetifmf.azcuba.cu style=cursor:pointer>manuel.jesus@zetifmf.azcuba.cu</a><br>Telf: (023) 577198<br>M&oacute;vil: (53) 53924528';
	}
	if(isset($_GET['p'])){
		$post='MSc. Carlos Poll&aacute;n Estrada';
		$ima='carlos4.jpg';
		$textoam='Especialista en Ciencias Inform&aacute;ticas del Archivo Hist&oacute;rico de Manzanillo<br>email: <a href=mailto:cpollan@ahmzllo.granma.inf.cu style=cursor:pointer>cpollan@ahmzllo.granma.inf.cu</a><br>M&oacute;vil: (53) 58222269';
	}	?>
