...
#############################################################################################################
	...
	if(isset($_REQUEST['ent']) OR isset($_REQUEST['ent'])){
...
<div id="paginac"><?php
		        if(($total_registros) !=0){ ?>
					...
					if(($total_registros) !=0){ ?>
						...
						<table WIDTH='438' BORDER='0' CELLPADDING='0' CELLSPACING='0' align="center">
							<TR>
								<TD></TD>
								<TD><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
									<tr>
										<td align="center" valign="middle"><div class="navegador"> 
											<form action="detalleexp.php" method="get" name="navga" id="navga">
											  <?php 
												...
												if(($pagina - 1) > 0) { ?>
												   <a class="tooltip" href='detalleexp.php?n&registros=<?php echo @$registros;?>&total_paginas=<?php echo @$total_paginas;?>&pagina=1&palabra=<?php echo @$palabra;?>&gral=<?php echo @$gral;?>&nom_custo=<?php echo @$nom_custo;?>&total_registros=<?php echo $total_registros;?>&asc=<?php echo @$asc;?>&orderby=<?php echo @$orderby; if(isset($_REQUEST['m'])){ ?>&m=m<?php } ?>'><img src='images/b_firstpage.png' width='16' align='absmiddle' height='16' border='0'><span onmouseover="this.style.cursor='pointer';" ><?php echo $registr1;?>...</span></a>&nbsp;
												   <a class="tooltip" href='detalleexp.php?n&registros=<?php echo @$registros;?>&total_paginas=<?php echo @$total_paginas;?>&pagina=<?php echo ($pagina-1);?>&palabra=<?php echo @$palabra;?>&gral=<?php echo @$gral;?>&nom_custo=<?php echo @$nom_custo;?>&total_registros=<?php echo $total_registros;?>&asc=<?php echo @$asc;?>&orderby=<?php echo @$orderby; if(isset($_REQUEST['m'])){ ?>&m=m<?php } ?>'><img src='images/b_prevpage.png' width='16' align='absmiddle' height='16' border='0'><span onmouseover="this.style.cursor='pointer';" ><?php echo $registr3;?>...</span></a>&nbsp;<?php 
												}
												if(($pagina + 1)<=$total_paginas)  { ?>
													<a class="tooltip" href='detalleexp.php?n&registros=<?php echo @$registros;?>&total_paginas=<?php echo @$total_paginas;?>&pagina=<?php echo ($pagina+1);?>&palabra=<?php echo @$palabra;?>&gral=<?php echo @$gral;?>&nom_custo=<?php echo @$nom_custo;?>&total_registros=<?php echo $total_registros;?>&asc=<?php echo @$asc;?>&orderby=<?php echo @$orderby; if(isset($_REQUEST['m'])){ ?>&m=m<?php } ?>'><img src='images/b_nextpage.png' width='16' align='absmiddle' height='16' border='0'><span onmouseover="this.style.cursor='pointer';" ><?php echo $registr2;?>...</span></a>&nbsp;
													<a class="tooltip" href='detalleexp.php?n&registros=<?php echo @$registros;?>&total_paginas=<?php echo @$total_paginas;?>&pagina=<?php echo ($total_paginas);?>&palabra=<?php echo @$palabra;?>&gral=<?php echo @$gral;?>&nom_custo=<?php echo @$_REQUEST['nom_custo']?>&total_registros=<?php echo $total_registros;?>&asc=<?php echo @$asc;?>&orderby=<?php echo @$orderby; if(isset($_REQUEST['m'])){ ?>&m=m<?php } ?>'><img src='images/b_lastpage.png' width='16' align='absmiddle' height='16' border='0'><span onmouseover="this.style.cursor='pointer';" ><?php echo $registr4;?>...</span></a><?php
												}	
