	...
	if(isset($_GET['d'])){
		...
		<form action="bajas.php" method="post" enctype="multipart/form-data" name="form1x1" onsubmit="return alertab();";>
			<table width="100%" border="0" cellspacing="2" cellpadding="2">	<?php 		
				...
				<tr> 
					<td width="20%" align="right"><?php echo $btcertifica1;?>:</td>
				  <td width="80%"><input class="form-control" type="file" name="quy1x" id="quy1x"/>	</td>
			    </tr>				
				<tr> 
				<td height="25" align="right" valign="top">No. Inv:</td>
					<td><input name="invx" readonly class="form-control" id="invx" value="<?php echo $rdelm1['inv'];?>" size="23" maxlength="10" /></td>
				</tr>
				<tr> 
			...
			for($k=0; $k<count($marcado); $k++){
				...
				<tr> 
				  ...
				  <td width="65%"><?php if(($rdelm1['tiene']) =="s"){ echo "<b>".$rdelm1['link']."<b>&nbsp;&nbsp;&nbsp;&nbsp;"; } ?>
				    <input class="form-control" type="file" name="quy1[]" id="quy1<?php echo $k;?>"/>
				  </td>
			    </tr>
				<tr> 
				<td height="25" align="right" valign="top">No. Inv :</td>
					<td><input name="inv[]" class="form-control" readonly id="inv[]" value="<?php echo $rdelm1['inv'];?>" size="23" maxlength="10" /><td><input name="titulo[]" type="hidden" class="form-control" id="titulo[]" value="<?php echo $rdelm1['titulo']; ?>" size="40"></td></td>
				</tr>
				<tr> 
				<td height="25" align="right" valign="top"><?php echo substr($btAreas,0,-1);?> :</td>
					<td><input name="idarea[]" readonly class="form-control" id="idarea[]" value="<?php echo $rdelm1['idarea'];?>" size="40" /></td>
				</tr>
				<tr>
				  <td align="right"><?php echo $Fecha;?>:</td>
				...
				<tr>
					...
					<td><input name="organo[]" class="form-control" id="organo[]" value="<?php echo $rdelm1['organo'];?>" onKeyUp="llamaorgano(this.value,'organo','organo[]','orgn');" size="23" maxlength="10" /><span id="orgn" onClick="document.getElementById('orgn').style.display =='none';" class="mstra"></span></td>
				</tr>
				<tr> 
					<td colspan="2">
