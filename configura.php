...
if ($cantconf ==0) {
  $sqlin = "INSERT INTO preferencias (usuario,salva,pass,visitas,columnas,busca,idunidades) VALUES ('".$_SESSION['valid_user']."','s','s','7','14','s','".$uni."')";
...
$existenciadt = mysqli_num_rows($resulta);
	...
	if(isset($_POST['guardar'])){ 
		...
		foreach($marcado as $Key){
			$upd="update preferencias set salva='".$salvac[$f]."', pass='".$passc[$f]."', visitas='".$visitasc[$f]."', columnas='".$columnas[$f]."',busca='".$buscac[$f]."' where id='".$Key."'";
	...
	if(isset($_POST['ok'])){ 
		...
		if(($numus) ==0){
		  $inpd="insert into preferencias (id,usuario,salva,pass,visitas,columnas, busca,idunidades) values(NULL,'".$usupref."','".$salvac."','".$passc."','".$visitasc."','".$columnas."','".$buscac."','".$idunida."')";
...
<fieldset class='fieldset'><?php if(isset($_POST['fusionar'])){  echo '<legend class="vistauserx">'.strtoupper($btfusionar).'</legend>';}
		...
		<legend class="vistauserx"><?php echo $leyenda[1]."--> ".$btdatabase.":&nbsp;<font color=red>".$database_miConex."</font>";?></legend>
		  <div id="openModal" class="modalDialog">
			  <div>
				  ...
				  <div align="justify"><div><?php echo $seguro;?><input class="btn" onclick="document.location='#closex';" value="<?php echo $btcancelar;?>">&nbsp;<input id="ok" class="btn" onclick="bValid();" value="<?php echo $btaceptar;?>"></div></div>			
			  </div>
		  </div>
			<form name="frm1" method="post" action="">
				<table border="0" width="100%" class="table" cellspacing="0" cellpadding="0">
					...
					while ($MainTableValues= mysqli_fetch_array($resultado)) { 
						$us1 = mysqli_query($miConex, "select * from datos_generales where id_datos='".$MainTableValues["idunidades"]."'") or die(mysql_error());
						...
						<tr bgcolor="<?php echo $uCPanel->ColorFila($p,$color1,$color2);?>" id="cur_tr_<?php echo $p;?>" onMouseOver="this.style.background='#CCFFCC'; colorear('<?php echo $p;?>','#CCFFCC');" onMouseOut="this.style.background='<?php echo $uCPanel->ColorFila($p,$color1,$color2);?>'; colorear('<?php echo $p;?>','#DBE2D0');" style="cursor:pointer;">  
							<td width="2%"><div onclick="marca1(<?php echo $p;?>,'#ffffff'); marca_edit(<?php echo $p;?>);" id="chequeadera<?php echo $p;?>" style="background:url(gfx/checkbox.gif) no-repeat scroll 0 -15px transparent;">&nbsp;&nbsp;&nbsp;&nbsp;</div><input onclick="marca1(<?php echo $p;?>,'#ffffff'); marca_edit(<?php echo $p;?>);" type="checkbox" style="display:none; cursor:pointer;" id="marcado<?php echo $p;?>"  name="marcado[]" value="<?php  echo $MainTableValues['id'];?>"></td>
				...
				<table border="0" width="100%" class="table" cellspacing="0" cellpadding="0">
					<tr> 
						...
						<tr>  
							...
							<td><div align="center"><input name="salva" type="checkbox" class="boton" value="s"></div></td>
							<td><div align="center"><input name="pass" class="boton" type="checkbox" value="s"></div></td>
							<td><div align="center"><input name="visitas" class="boton" type="text" onKeyPress="return acceptNum(event);" size="3"></div></td>
							<td><div align="center"><input name="columnas" class="boton" type="text" onKeyPress="return acceptNum(event);" size="3"></div></td>
							<td><div align="center"><input name="busca" type="checkbox" value="s" class="boton" id="busca"></div></td>
						</tr>
					<tr> 
						<td colspan="7"></td>
					</tr>
	...
	if(isset($_GET["mc"]) ){
		  ...
		  <tr>
			<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $btdatosentidad;?></b></td>
		  </tr>
			  <tr>
				<td width="116" height="26" align="right"><?php echo $btNombre;?>:</td>
				<td width="440">
				  <input onkeypress="return handleEnter(this, event)"  name="entidad[]" type="text" id="entidad" class="imput"  value="<?php echo $row['entidad'];?>" size="50"/>
				 </td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td><input onkeypress="return handleEnter(this, event)"  name="mail[]" type="email" class="imputs" id="mail" size="20" value="<?php echo $row['mail'];?>"/></td>
				</tr>
			  <tr>
				<td height="24" align="right"><?php echo $btCodigo1;?>:</td>
				<td><input onkeypress="return handleEnter(this, event)"  name="codigo[]" type="text" class="imput" id="codigo" size="20" value="<?php echo $row['codigo'];?>"/></td>
				</tr>
			  <tr>
				<td height="26" align="right"><?php echo $SITIO1;?>:</td>
				<td><input onkeypress="return handleEnter(this, event)"  name="web[]" type="text" id="web" class="imput" value="<?php echo $row['web'];?>" size="40"/></td>
			  </tr>
			  <tr>
				<td align="right"><?php echo $provincia;?>:</td>
				<td><select onkeypress="return handleEnter(this, event)"  name="provincia[]" class="selectuno"><?php		
			  ...
			  <tr>
				...
				<td><input name="id_datos[]" type="hidden" value="<?php echo $row['id_datos'];?>"/><input onkeypress="return handleEnter(this, event)"  name="smtp[]" type="text" value="<?php echo $row['smtp'];?>" class="imput" id="smtp" size="30"/></td>
			  </tr>
		  <tr>
			<td colspan="2">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="modifica" type="submit" class="btn" id="modifica" onMouseOVer="this.style.cursor='pointer';" value="<?php echo $btaceptar;?>" />&nbsp;&nbsp;	
				<input class="btn" type="button" name="cancela" value="<?php echo $btcancelar;?>" onclick="document.location='configura.php?p=d';"> 
			</td>
		  </tr></form>
		</table><?php 
	} ?>
	...
	if(isset($_POST['funcionar'])){
		...
		<script type="text/javascript">document.cookie = "unidades=1;"; window.parent.location='configura.php?p=d';</script><?php
	}
